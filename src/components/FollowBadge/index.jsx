const FollowBadge = () => {
    ...
    return (
        <div className="user-row bg-white rounded-xl shadow-xl flex flex items-center justify-center cursor-pointer my-1 p-4 duration-300 sm:flex-row sm:py-4 sm:px-8 hover:bg-[#f6f8f9]">
            <div className="user items-center justify-center flex space-x-3 flex-row sm:flex-row sm:text-left w-[9/12]">
            ...
            <div className="user-option mx-auto sm:ml-auto sm:mr-0 w-[3/12]">
